  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-blue-50">
      <div className="bg-white rounded-2xl shadow-2xl p-10 w-full max-w-lg flex flex-col items-center">
        ...
        <h2 className="text-3xl font-extrabold mb-2 text-center">Admin Registration</h2>
        <p className="text-lg text-gray-600 mb-8 text-center">Register as an admin for Travel Buddy</p>
        ...
        <div className="mt-4 w-full flex flex-col items-center">
          <GoogleLogin
            onSuccess={async credentialResponse => {
              setError("");
              try {
                await apiService.auth.googleAuth({ credential: credentialResponse.credential, role: "admin" });
                setSuccess(true);
